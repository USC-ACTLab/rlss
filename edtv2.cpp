...
edtv2::edtv2(double ss, double xm, double xM, double ym, double yM, double T): step_size(ss), x_min(xm), x_max(xM), y_min(ym), y_max(yM), tau(T) {
...
double edtv2::cost(vector<double>& P, double dur, double ct, vector<double>& grad) {
  double ss = step_size;
  ...
  double interpolation = (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) -
  ...
  if(interpolation < tau) {
    ...
    if(grad.size() > 0) {
      grad = vector<double>{
        2*(((-((pow(1 - ct/dur,7)*q11)/ss) + (pow(1 - ct/dur,7)*q21)/ss)*(y2 - pow(1 - ct/dur,7)*P[0*2+1] - (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur -
           (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) -
           (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) - (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) - (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss +
      ((-((pow(1 - ct/dur,7)*q12)/ss) + (pow(1 - ct/dur,7)*q22)/ss)*(-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur +
           (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) + (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) +
           (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) + (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss)*
    (-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*(-((pow(1 - ct/dur,7)*((q11*
                (x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                  (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                  (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
             (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
                  (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) + (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) +
    ...
    (-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((((-7*ct*pow(1 - ct/dur,6)*q11)/(dur*ss) + (7*ct*pow(1 - ct/dur,6)*q21)/(dur*ss))*
         (y2 - pow(1 - ct/dur,7)*P[0*2+1] - (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) -
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) - (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) -
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss + (((-7*ct*pow(1 - ct/dur,6)*q12)/(dur*ss) + (7*ct*pow(1 - ct/dur,6)*q22)/(dur*ss))*
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss)*(-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
           (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) + (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) +
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((-7*ct*pow(1 - ct/dur,6)*((q11*
              (x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
           (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
    ...
    (-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((((-21*pow(ct,2)*pow(1 - ct/dur,5)*q11)/(pow(dur,2)*ss) + (21*pow(ct,2)*pow(1 - ct/dur,5)*q21)/(pow(dur,2)*ss))*
         (y2 - pow(1 - ct/dur,7)*P[0*2+1] - (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) -
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) - (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((-21*pow(ct,2)*pow(1 - ct/dur,5)*
         ((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
           (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) + (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) +
    ...
    (-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((((-35*pow(ct,3)*pow(1 - ct/dur,4)*q11)/(pow(dur,3)*ss) + (35*pow(ct,3)*pow(1 - ct/dur,4)*q21)/(pow(dur,3)*ss))*
         (y2 - pow(1 - ct/dur,7)*P[0*2+1] - (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) -
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) - (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((-35*pow(ct,3)*pow(1 - ct/dur,4)*
         ((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
           (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
    ...
    (-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((((-35*pow(ct,4)*pow(1 - ct/dur,3)*q11)/(pow(dur,4)*ss) + (35*pow(ct,4)*pow(1 - ct/dur,3)*q21)/(pow(dur,4)*ss))*
         (y2 - pow(1 - ct/dur,7)*P[0*2+1] - (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) -
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) - (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((-35*pow(ct,4)*pow(1 - ct/dur,3)*
         ((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
           (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
    ...
    (-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((((-21*pow(ct,5)*pow(1 - ct/dur,2)*q11)/(pow(dur,5)*ss) + (21*pow(ct,5)*pow(1 - ct/dur,2)*q21)/(pow(dur,5)*ss))*
         (y2 - pow(1 - ct/dur,7)*P[0*2+1] - (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) -
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) - (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((-21*pow(ct,5)*pow(1 - ct/dur,2)*
         ((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
           (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
    ...
    (-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((((-7*pow(ct,6)*(1 - ct/dur)*q11)/(pow(dur,6)*ss) + (7*pow(ct,6)*(1 - ct/dur)*q21)/(pow(dur,6)*ss))*
         (y2 - pow(1 - ct/dur,7)*P[0*2+1] - (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) -
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) - (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*((-7*pow(ct,6)*(1 - ct/dur)*
         ((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
                (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
                (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
           (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
    ...
    (-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*(((-((pow(ct,7)*q11)/(pow(dur,7)*ss)) + (pow(ct,7)*q21)/(pow(dur,7)*ss))*
         (y2 - pow(1 - ct/dur,7)*P[0*2+1] - (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) - (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) -
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) - (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) -
         ...
         (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
           (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
           (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss),2*(-((pow(ct,7)*((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur -
    ...
    return pow(-tau + (((q11*(x2 - pow(1 - ct/dur,7)*P[0*2+0] - (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur - (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) -
              (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) - (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) - (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) -
              (7*pow(ct,6)*(1 - ct/dur)*P[6*2+0])/pow(dur,6) - (pow(ct,7)*P[7*2+0])/pow(dur,7)))/ss +
         (q21*(-x1 + pow(1 - ct/dur,7)*P[0*2+0] + (7*ct*pow(1 - ct/dur,6)*P[1*2+0])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+0])/pow(dur,2) +
              (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+0])/pow(dur,3) + (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+0])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+0])/pow(dur,5) +
       ...
       (-y1 + pow(1 - ct/dur,7)*P[0*2+1] + (7*ct*pow(1 - ct/dur,6)*P[1*2+1])/dur + (21*pow(ct,2)*pow(1 - ct/dur,5)*P[2*2+1])/pow(dur,2) + (35*pow(ct,3)*pow(1 - ct/dur,4)*P[3*2+1])/pow(dur,3) +
         (35*pow(ct,4)*pow(1 - ct/dur,3)*P[4*2+1])/pow(dur,4) + (21*pow(ct,5)*pow(1 - ct/dur,2)*P[5*2+1])/pow(dur,5) + (7*pow(ct,6)*(1 - ct/dur)*P[6*2+1])/pow(dur,6) +
         (pow(ct,7)*P[7*2+1])/pow(dur,7)))/ss,2);
