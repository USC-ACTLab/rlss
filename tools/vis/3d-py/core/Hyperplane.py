...
"""
Hyperplane container class for visualization. Supports both 2d and 3d-py marker output
...
class Hyperplane(object):
    ...
    """
    Generates 3d-py marker output from given hyperplane as a cubic volume.
