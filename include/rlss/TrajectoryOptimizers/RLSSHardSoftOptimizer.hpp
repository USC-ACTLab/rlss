    ...
    public:
        ...
        std::optional<PiecewiseCurve> optimize(
            ...
            for(const auto& hp: robot_to_robot_hps) {
                m_qp_generator.addHyperplaneConstraintForPiece(0, hp, true, 1000);
...
//                    mathematica.obstacleCollisionAvoidanceHyperplane(shp);
                    ...
                    m_qp_generator.addHyperplaneConstraintForPiece(p_idx, shp, true, 1000);
                }
            }
            ...
            for(
                ...
                for(unsigned int k = 0; k <= m_continuity_upto; k++) {
                    ...
                    m_qp_generator.addContinuityConstraint(p_idx, k, true, 10000);
                }
            }
